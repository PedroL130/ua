...
-- Equation(s):
-- \clkOut~1_combout\ = (\Add1~4_combout\ & (s_counter(2) & (\Add1~6_combout\ $ (!s_counter(3))))) # (!\Add1~4_combout\ & (!s_counter(2) & (\Add1~6_combout\ $ (!s_counter(3)))))
...
-- Equation(s):
-- \clkOut~2_combout\ = (\Add1~8_combout\ & (s_counter(4) & (\Add1~10_combout\ $ (!s_counter(5))))) # (!\Add1~8_combout\ & (!s_counter(4) & (\Add1~10_combout\ $ (!s_counter(5)))))
...
-- Equation(s):
-- \clkOut~7_combout\ = (\Add1~24_combout\ & (s_counter(12) & (\Add1~26_combout\ $ (!s_counter(13))))) # (!\Add1~24_combout\ & (!s_counter(12) & (\Add1~26_combout\ $ (!s_counter(13)))))
...
-- Equation(s):
-- \clkOut~10_combout\ = (\Add1~32_combout\ & (s_counter(16) & (\Add1~34_combout\ $ (!s_counter(17))))) # (!\Add1~32_combout\ & (!s_counter(16) & (\Add1~34_combout\ $ (!s_counter(17)))))
...
-- Equation(s):
-- \clkOut~12_combout\ = (\Add1~40_combout\ & (s_counter(20) & (\Add1~42_combout\ $ (!s_counter(21))))) # (!\Add1~40_combout\ & (!s_counter(20) & (\Add1~42_combout\ $ (!s_counter(21)))))
...
-- Equation(s):
-- \clkOut~13_combout\ = (\Add1~44_combout\ & (s_counter(22) & (\Add1~46_combout\ $ (!s_counter(23))))) # (!\Add1~44_combout\ & (!s_counter(22) & (\Add1~46_combout\ $ (!s_counter(23)))))
...
-- Equation(s):
-- \clkOut~15_combout\ = (\Add1~48_combout\ & (s_counter(24) & (\Add1~50_combout\ $ (!s_counter(25))))) # (!\Add1~48_combout\ & (!s_counter(24) & (\Add1~50_combout\ $ (!s_counter(25)))))
...
-- Equation(s):
-- \clkOut~17_combout\ = (\Add1~56_combout\ & (s_counter(28) & (\Add1~58_combout\ $ (!s_counter(29))))) # (!\Add1~56_combout\ & (!s_counter(28) & (\Add1~58_combout\ $ (!s_counter(29)))))
...
-- Equation(s):
-- \clkOut~18_combout\ = (\Add1~60_combout\ & (s_counter(30) & (\Add1~62_combout\ $ (!s_counter(31))))) # (!\Add1~60_combout\ & (!s_counter(30) & (\Add1~62_combout\ $ (!s_counter(31)))))
